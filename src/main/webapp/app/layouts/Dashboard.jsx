...
import MyJobAd from '../pages/myJobAd';
            ...
            <Container className="main" >                
                <Grid stackable>
                    ...
                    <Grid.Column width={12}>
                        ...
                        <Route exact path="/myJobAd" component={MyJobAd}/>
                        <Route exact path="/myJobApplication" component={MyJobApplication}/>
                        <Route exact path="/myCandidate" component={MyCandidate}/>
                    </Grid.Column>
                </Grid>
            </Container>
            <Footer/>
